<template>
  <section class="contact__area grey-bg-2 pt-20 pb-90 p-relative fix">
    <div class="contact__shape">
      <img
        class="contact-shape-5"
        src="../../assets/img/contact/contact-shape-5.png"
        alt=""
      />
      <img
        class="contact-shape-4"
        src="../../assets/img/contact/contact-shape-4.png"
        alt=""
      />
    </div>
    <div class="container">
      <div class="row">
        <div
          class="col-xxl-5 offset-xxl-1 col-xl-5 offset-xl-1 col-lg-5 offset-lg-1 col-md-6"
        >
          <div class="contact__item text-center mb-30 transition-3 white-bg">
            <div
              class="contact__icon d-flex justify-content-center align-items-end"
            >
            ...
            <div class="contact__content">
              ...
              <router-link to="/contact" class="e-btn e-btn-border"
                >Visit Documentation</router-link
              >
            </div>
          </div>
        </div>
